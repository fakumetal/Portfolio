...
import TechMarquee from "../../components/Home/TechMarquee/TechMarquee";
...
const Home = () => {
  ...
  return (
    <>
      <section id="inicio" ref={(el) => (sectionsRef.current[0] = el)} className="banner fade-in-section">
        <Banner />
      </section>
      <TechMarquee />
      ...
      <a className="scroll-to-top" href="#inicio" aria-label={t("home.scrollTop")}>
        <img src="/up.svg" alt="" />
      </a>
    </>
  );
